...
public class Game extends JPanel {
	...
	public Game() {
		heroAircraft = new HeroAircraft(512 / 2, 768 - ImageManager.HERO_IMAGE.getHeight(), 0, 0, 100);
	...
	/**
	 * 后处理： 1. 删除无效的子弹 2. 删除无效的敌机 3. 检查英雄机生存
	 * <p>
	 * 无效的原因可能是撞击或者飞出边界
	 */
	...
	public void paint(Graphics g) {
		...
		// 绘制背景,图片滚动
		g.drawImage(ImageManager.BACKGROUND_IMAGE, 0, this.backGroundTop - 768, null);
